...
public class script extends IteratingVUserScript {
	...
	public String removeScriptTag(DOMElement element, String value) throws Exception {
		
		//Start of Removing script tag -- IE9 Change
		List<DOMElement> scriptElements = element.getElementsByTagName("script");
	...
	public DOMElement getNextElement(DOMElement component, String compType) throws Exception{
		...
		while(nextComp != null){
			...
			//this.sop("nextCompTag :"+nextCompTag+"  compType:"+compType);
