...
public class GENLIB extends FuncLibraryWrapper
{
	 ...
	 * @throws Exception
	 */
	public String getDocumentIndex(String popupTitle, String popUpText) throws AbstractScriptException {
		checkInit();
		return (String) callFunction("getDocumentIndex", popupTitle, popUpText);
	}

	public List<String> getDocumentIndexes(String popupTitle) throws AbstractScriptException {
		checkInit();
		return (List<String>) callFunction("getDocumentIndexes", popupTitle);
	}

	public String popupGetText(String title, String beforeWithIndex, String afterWithIndex) throws AbstractScriptException {
		checkInit();
		return (String) callFunction("popupGetText", title, beforeWithIndex, afterWithIndex);
	}

	public boolean popupVerifyTextWithBeforeAfter(String title, String expectedText, String beforeWithIndex, String afterWithIndex) throws AbstractScriptException {
		checkInit();
		return (Boolean) callFunction("popupVerifyTextWithBeforeAfter", title, expectedText, beforeWithIndex, afterWithIndex);
	}

	public boolean popupVerifyText(String title, String expectedText) throws AbstractScriptException {
		checkInit();
		return (Boolean) callFunction("popupVerifyText", title, expectedText);
	}

	/**
	 * @param modalPopupDetails modalPopupDetails = "Warning;Yes" modalPopupDetails.split(";")[0]	- Title modalPopupDetails.split(";")[1]	- Button Name
	 * @throws Exception
	 */
	public void clickPopupButton(String modalPopupDetails) throws AbstractScriptException {
		checkInit();
		callFunction("clickPopupButton", modalPopupDetails);
	}

	/**
	 * @param modalPopupDetails modalPopupDetails = "Warning;LinkName" modalPopupDetails.split(";")[0]	- Title modalPopupDetails.split(";")[1]	- Link Name
	 * @throws Exception
	 */
	public void clickPopupLink(String modalPopupDetails) throws AbstractScriptException {
		checkInit();
		callFunction("clickPopupLink", modalPopupDetails);
	}
	...
	public void webVerifyText(String text, String docIndex) throws AbstractScriptException {
		checkInit();
		callFunction("webVerifyText", text, docIndex);
	}
	...
	public boolean webVerifyText(String expectedText, String docIndex, String beforeWithIndex, String afterWithIndex) throws AbstractScriptException {
		checkInit();
		return (Boolean) callFunction("webVerifyText", expectedText, docIndex, beforeWithIndex, afterWithIndex);
	}
	...
	public boolean webVerifyText(String expectedText, String docIndex, String beforeText, String afterText, String beforeIndex, String afterIndex) throws AbstractScriptException {
		checkInit();
		return (Boolean) callFunction("webVerifyText", expectedText, docIndex, beforeText, afterText, beforeIndex, afterIndex);
	}
	...
	public boolean webVerifyBetweenText(String expectedText, String docIndex, String beforeText, String afterText, String beforeIndex, String afterIndex) throws AbstractScriptException {
		checkInit();
		return (Boolean) callFunction("webVerifyBetweenText", expectedText, docIndex, beforeText, afterText, beforeIndex, afterIndex);
	}
	...
	public boolean webVerifyBeforeText(String expectedText, String docIndex, String afterText, String sWordsRequired, String sIndex) throws AbstractScriptException {
		checkInit();
		return (Boolean) callFunction("webVerifyBeforeText", expectedText, docIndex, afterText, sWordsRequired, sIndex);
	}
	...
	public boolean webVerifyAfterText(String expectedText, String docIndex, String beforeText, String sWordsRequired, String sIndex) throws AbstractScriptException {
		checkInit();
		return (Boolean) callFunction("webVerifyAfterText", expectedText, docIndex, beforeText, sWordsRequired, sIndex);
	}
	...
	public String webGetTextInTable(String docIndex, String text, String sWordsRequired, String sIndex, String action) throws AbstractScriptException {
		checkInit();
		return (String) callFunction("webGetTextInTable", docIndex, text, sWordsRequired, sIndex, action);
	}
	...
	public String webGetText(String docIndex, String beforeWithIndex, String afterWithIndex) throws AbstractScriptException {
		checkInit();
		return (String) callFunction("webGetText", docIndex, beforeWithIndex, afterWithIndex);
	}
	...
	public String webGetText(String docIndex, String beforeText, String afterText, String beforeIndex, String afterIndex) throws AbstractScriptException {
		checkInit();
		return (String) callFunction("webGetText", docIndex, beforeText, afterText, beforeIndex, afterIndex);
	}
	...
	public String webGetBetweenText(String docIndex, String before, String after, String beforeIndex, String afterIndex) throws AbstractScriptException {
		checkInit();
		return (String) callFunction("webGetBetweenText", docIndex, before, after, beforeIndex, afterIndex);
	}
	...
	public String webGetBeforeText(String docIndex, String afterText, String sWordsRequired, String sIndex) throws AbstractScriptException {
		checkInit();
		return (String) callFunction("webGetBeforeText", docIndex, afterText, sWordsRequired, sIndex);
	}
	...
	public String webGetAfterText(String docIndex, String beforeText, String sWordsRequired, String sIndex) throws AbstractScriptException {
		checkInit();
		return (String) callFunction("webGetAfterText", docIndex, beforeText, sWordsRequired, sIndex);
	}
	...
	public String convertNumberToWords(int index) throws AbstractScriptException {
		checkInit();
		return (String) callFunction("convertNumberToWords", index);
	}
