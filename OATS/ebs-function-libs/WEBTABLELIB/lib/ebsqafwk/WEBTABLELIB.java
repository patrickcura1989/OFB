...
public class WEBTABLELIB extends FuncLibraryWrapper
{
	...
	public HashMap<String, String> convertactionsToHashMap(String[] singleAction) throws AbstractScriptException {
		checkInit();
		return (HashMap<String, String>) callFunction("convertactionsToHashMap", (Object) singleAction);
	}
