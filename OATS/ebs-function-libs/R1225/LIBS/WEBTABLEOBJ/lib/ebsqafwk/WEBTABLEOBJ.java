...
public class WEBTABLEOBJ<WebTable> extends FuncLibraryWrapper
{
	...
	public HashMap<String, String> getColumnAttributeDetails(String tableColLogicalName, HashMap<String, String> colDetails) throws AbstractScriptException {
		checkInit();
		return (HashMap<String, String>) callFunction("getColumnAttributeDetails", tableColLogicalName, colDetails);
	}
