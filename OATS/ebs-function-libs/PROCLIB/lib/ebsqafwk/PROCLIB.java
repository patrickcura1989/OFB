...
public class PROCLIB extends FuncLibraryWrapper
{
	...
	public void addToCartAddFavList(String itemName, String source, String quantity, String listName, String action) throws AbstractScriptException {
		checkInit();
		callFunction("addToCartAddFavList", itemName, source, quantity, listName, action);
	}
	 ...
	 * @throws Exception
	 */
	public void setTimeCard(String startTime, String noOfDays) throws AbstractScriptException {
		checkInit();
		callFunction("setTimeCard", startTime, noOfDays);
	}
	 ...
	 * @param itemName -- Item Name that needs to be added to favorites. 
	 * @throws Exception
	 */
	public void addToFavoritesInCompareBasedOnItem(String itemName) throws AbstractScriptException {
		checkInit();
		callFunction("addToFavoritesInCompareBasedOnItem", itemName);
	}
